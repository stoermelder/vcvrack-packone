// MIDISTEP test cases. Included by MidiStep.test.cpp inside namespace __module.
// Not a standalone header: MidiStep.test.hpp supplies everything these cases use.
