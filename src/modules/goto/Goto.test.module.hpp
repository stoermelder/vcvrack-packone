// GOTO test cases. Included by Goto.test.cpp inside namespace __module.
// Not a standalone header: Goto.test.hpp supplies everything these cases use.

TEST_CASE("Construction and initialization", "[Goto]") {
	Test::ModuleScaffold<GotoModule<10>> mods;
	GotoModule<10>* m = mods.create("Goto");
...
TEST_CASE("Preset JSON clamps out-of-range scalars", "[Goto][JSON]") {
	Test::Harness h;
