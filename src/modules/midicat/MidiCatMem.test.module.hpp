// MIDICATMEM test cases. Included by MidiCatMem.test.cpp inside namespace __module.
// Not a standalone header: MidiCatMem.test.hpp supplies everything these cases use.
