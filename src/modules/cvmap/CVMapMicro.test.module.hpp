// CVMAPMICRO test cases. Included by CVMapMicro.test.cpp inside namespace __module.
// Not a standalone header: CVMapMicro.test.hpp supplies everything these cases use.
