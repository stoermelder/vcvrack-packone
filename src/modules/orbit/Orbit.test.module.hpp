// ORBIT test cases. Included by Orbit.test.cpp inside namespace __module.
// Not a standalone header: Orbit.test.hpp supplies everything these cases use.
...
TEST_CASE("Preset JSON clamps out-of-range scalars", "[Orbit][JSON]") {
	Test::Harness h;
