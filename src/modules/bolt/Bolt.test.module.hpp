// BOLT test cases. Included by Bolt.test.cpp inside namespace __module.
// Not a standalone header: Bolt.test.hpp supplies everything these cases use.
...
TEST_CASE("Preset JSON clamps out-of-range scalars", "[Bolt][JSON]") {
	Test::Harness h;
