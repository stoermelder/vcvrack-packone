// INTERMIXGATE test cases. Included by IntermixGate.test.cpp inside namespace __module.
// Not a standalone header: IntermixGate.test.hpp supplies everything these cases use.
