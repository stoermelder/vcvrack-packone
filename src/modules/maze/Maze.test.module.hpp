// MAZE test cases. Included by Maze.test.cpp inside namespace __module.
// Not a standalone header: Maze.test.hpp supplies everything these cases use.
...
TEST_CASE("Preset JSON clamps out-of-range scalars", "[Maze][JSON]") {
	Test::Harness h;
