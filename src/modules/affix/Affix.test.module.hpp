// AFFIX test cases. Included by Affix.test.cpp inside namespace __module.
// Not a standalone header: Affix.test.hpp supplies everything these cases use.
...
TEST_CASE("Preset JSON clamps out-of-range scalars", "[Affix][JSON]") {
	Test::Harness h;
