// CVMAP test cases. Included by CvMap.test.cpp inside namespace __module.
// Not a standalone header: CvMap.test.hpp supplies everything these cases use.
...
TEST_CASE("Preset JSON clamps out-of-range scalars", "[CvMap][JSON]") {
	Test::Harness h;
	auto module = h.addModule<CVMapModule>("CVMap");
