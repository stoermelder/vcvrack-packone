// ROTORA test cases. Included by RotorA.test.cpp inside namespace __module.
// Not a standalone header: RotorA.test.hpp supplies everything these cases use.
...
TEST_CASE("Preset JSON clamps out-of-range scalars", "[RotorA][JSON]") {
	Test::Harness h;
