...
struct StripPpWidget : StripWidgetBase<StripPpModule> {
	...
	void appendContextMenu(Menu* menu) override {
		...
		menu->addChild(createMenuItem("Paste", RACK_MOD_CTRL_NAME "+" RACK_MOD_SHIFT_NAME "+V", [=]() { vcvsPasteClipboard(); }));
