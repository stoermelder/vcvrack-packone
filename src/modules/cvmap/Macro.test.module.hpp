// MACRO test cases. Included by Macro.test.cpp inside namespace __module.
// Not a standalone header: Macro.test.hpp supplies everything these cases use.
...
TEST_CASE("Preset JSON clamps out-of-range scalars", "[Macro][JSON]") {
	Test::Harness h;
	auto module = h.addModule<MacroModule>("Macro");
