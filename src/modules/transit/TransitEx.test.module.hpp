// TRANSITEX test cases. Included by TransitEx.test.cpp inside namespace __module.
// Not a standalone header: TransitEx.test.hpp supplies everything these cases use.
