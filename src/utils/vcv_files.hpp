 ...
 */
static ModuleWidget* __attribute__((unused)) moduleFromJson(json_t* moduleJ, int64_t& oldId) {
    // Get slugs
 ...
 * @return ModuleWidget pointer if successful, NULL otherwise
 */
static ModuleWidget* __attribute__((unused)) moduleToRack(json_t* moduleJ, moduleToRackPos modPos, Rect& box, int64_t& oldId) {
 ...
 */
static void __attribute__((unused)) vcvsCheckUnavailable(json_t* rootJ) {
 ...
 */
static std::vector<history::Action*>* __attribute__((unused)) vcvsFromJson_modules(json_t* rootJ, std::map<int64_t, ModuleWidget*>& modules) {
 ...
 */
static void __attribute__((unused)) vcvsFromJson_presets_fixMapping(json_t* moduleJ, std::map<int64_t, ModuleWidget*>& modules) {
 ...
 * @return Vector of history actions for undo support
 */
static std::vector<history::Action*>* __attribute__((unused)) vcvsFromJson_presets(json_t* rootJ, std::map<int64_t, ModuleWidget*>& modules) {
    std::vector<history::Action*>* undoActions = new std::vector<history::Action*>;
 ...
 * @return Vector of history actions for undo support
 */
static std::vector<history::Action*>* __attribute__((unused)) vcvsFromJson_cables(json_t* rootJ, std::map<int64_t, ModuleWidget*>& modules) {
    std::vector<history::Action*>* undoActions = new std::vector<history::Action*>;
 ...
 */
static const std::string __attribute__((unused)) vcvsFromJson(json_t* rootJ, std::string undoActionName = "") {
 ...
 */
static void __attribute__((unused)) vcvsLoadFile(std::string path, std::string undoActionName = "") {
 ...
 */
static void __attribute__((unused)) vcvsPasteClipboard(std::string undoActionName = "") {
 ...
 */
static std::string __attribute__((unused)) vcvsLoadFileDialog(bool load, std::string undoActionName = "") {
 ...
 */
static float __attribute__((unused)) getModuleWidth(json_t* moduleJ) {
    json_t* pluginSlugJ = json_object_get(moduleJ, "plugin");
 ...
 */
static json_t* __attribute__((unused)) convertVcvssToVcvs(json_t* vcvssJ) {
