...
If _Ratcheting_ is disabled by context menu option of a playhead (see 
...
The grid can be switched to _Edit-mode_ on the context menu. While in _Edit-mode_ the reset-positions of each playhead can be modified by drag and drop. Everytime _RESET_ is triggered the respective playhead will return to this cell on the grid.
