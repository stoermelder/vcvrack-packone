// MIDICATCLK test cases. Included by MidiCatClk.test.cpp inside namespace __module.
// Not a standalone header: MidiCatClk.test.hpp supplies everything these cases use.
