// FOURROUNDS test cases. Included by FourRounds.test.cpp inside namespace __module.
// Not a standalone header: FourRounds.test.hpp supplies everything these cases use.
