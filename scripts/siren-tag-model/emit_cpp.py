"""Emit a C++ header fragment containing the trained model as static functions.
...
The result is a header that compiles cleanly into the plugin and gives
...
def emit_cpp(
    ...
    parts.append("// aren't redefined 15 times.)")
