// CVMAPCTX test cases. Included by CVMapCtx.test.cpp inside namespace __module.
// Not a standalone header: CVMapCtx.test.hpp supplies everything these cases use.
