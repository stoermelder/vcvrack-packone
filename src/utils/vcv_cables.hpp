...
static CableWidget* __attribute__((unused)) findCable(int64_t outputModuleId, int outputPortId, int64_t inputModuleId, int inputPortId) {
...
static void __attribute__((unused)) removeCable(CableWidget* cw, bool addToHistory = true) {
...
static void __attribute__((unused)) addCableToPort(int64_t outModuleId, int outPortId, int64_t inModuleId, int inPortId, bool addToHistory = true) {
