// INTERMIXFADE test cases. Included by IntermixFade.test.cpp inside namespace __module.
// Not a standalone header: IntermixFade.test.hpp supplies everything these cases use.
