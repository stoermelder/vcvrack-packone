// DIRT test cases. Included by Dirt.test.cpp inside namespace __module.
// Not a standalone header: Dirt.test.hpp supplies everything these cases use.
...
TEST_CASE("Preset JSON clamps out-of-range scalars", "[Dirt][JSON]") {
	Test::Harness h;
	auto module = h.addModule<DirtModule>("Dirt");
