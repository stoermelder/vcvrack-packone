// SPIN test cases. Included by Spin.test.cpp inside namespace __module.
// Not a standalone header: Spin.test.hpp supplies everything these cases use.
...
TEST_CASE("Preset JSON clamps out-of-range scalars", "[Spin][JSON]") {
	Test::Harness h;
	auto module = h.addModule<SpinModule>("Spin");
